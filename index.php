  ...
  <div class="login mdl-shadow--4dp">
    ...
    <?php
      ...
      <?php
  		...
  		?>
  		<p><a class="mdl-button md-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" href="<?=$link?>">Reservar horas<span class="mdl-ripple"></span></a><?php if (isadmin()) {?> <a class="mdl-button md-js-button mdl-button--raised mdl-js-ripple-effect" href="dashboard.php">Dashboard<span class="mdl-ripple"></span></a><?php } ?> <a class="mdl-button md-js-button mdl-button--raised mdl-js-ripple-effect" href="logout.php">Cerrar sesión<span class="mdl-ripple"></span></a></p>
      <?php
    } else {
      ?>
